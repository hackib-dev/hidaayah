...
export default function SignupPage() {
  ...
  const handleSignup = async () => {
    ...
    try {
      await signup();
      // signup() redirects the browser to QF OAuth
    } catch {
      setError('Could not redirect to sign up. Please try again.');
      setLoading(false);
    }
  };
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground text-center">
            Account creation is handled securely via Quran Foundation — you&apos;ll be redirected
