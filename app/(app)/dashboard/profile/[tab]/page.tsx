...
const COUNTRIES: { code: string; name: string }[] = [
  ...
  { code: 'KM', name: 'Comoros' }, { code: 'CD', name: 'Congo (DRC)' },
  { code: 'CG', name: 'Congo (Republic)' }, { code: 'CI', name: "Côte d'Ivoire" },
  ...
  { code: 'ER', name: 'Eritrea' }, { code: 'ET', name: 'Ethiopia' },
  { code: 'FI', name: 'Finland' }, { code: 'FR', name: 'France' },
  { code: 'GA', name: 'Gabon' }, { code: 'GM', name: 'Gambia' },
  { code: 'DE', name: 'Germany' }, { code: 'GH', name: 'Ghana' },
  { code: 'GR', name: 'Greece' }, { code: 'GN', name: 'Guinea' },
  { code: 'GW', name: 'Guinea-Bissau' }, { code: 'IN', name: 'India' },
